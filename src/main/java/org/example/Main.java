...
public class Main {
    static AtomicInteger beautifulWordsWithSizeThreeCounter = new AtomicInteger(0);
    static AtomicInteger beautifulWordsWithSizeFourCounter = new AtomicInteger(0);
    static AtomicInteger beautifulWordsWithSizeFiveCounter = new AtomicInteger(0);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Красивых слов с длиной 3: " + beautifulWordsWithSizeThreeCounter + " шт");
        System.out.println("Красивых слов с длиной 4: " + beautifulWordsWithSizeFourCounter + " шт");
        System.out.println("Красивых слов с длиной 5: " + beautifulWordsWithSizeFiveCounter + " шт");
    }

    public static void updateCounter(String str) {
        if (str.length() == 3) {
            beautifulWordsWithSizeThreeCounter.addAndGet(1);
        } else if (str.length() == 4) {
            beautifulWordsWithSizeFourCounter.addAndGet(1);
        } else if (str.length() == 5) {
            beautifulWordsWithSizeFiveCounter.addAndGet(1);
        }
    }
